...
from autodub.services.video_download import _load_yt_dlp, _youtube_dl_options
from autodub.vendor.douyin_xbogus import XBogus
...
def _candidate(aweme: dict) -> dict | None:
    ...
    if not isinstance(video, dict) or not video.get("play_addr"):
        return None
