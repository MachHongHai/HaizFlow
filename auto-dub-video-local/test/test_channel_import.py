...
from autodub.schemas.channel_import import ChannelImportRequest, ChannelVideoCandidate
from autodub.desktop.channel_import import ChannelImportCoordinator
from autodub.services.channel_import import (
...
from autodub.services.douyin_channel_worker import _candidate as douyin_candidate
...
class ChannelScanTests(unittest.TestCase):
    @staticmethod
    def candidate(video_id, *, views, duration, published):
    ...
    def test_popular_scan_filters_duration_sorts_and_marks_duplicates(self):
        ...
        with patch(
            "autodub.services.channel_import._scan_with_ytdlp",
