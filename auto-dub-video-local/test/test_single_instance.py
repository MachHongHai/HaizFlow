...
from autodub.desktop.single_instance import SingleInstanceCoordinator, default_server_name
...
class SingleInstanceTests(unittest.TestCase):
    ...
    def test_default_lock_name_is_stable_and_user_scoped(self):
        ...
        self.assertRegex(default_server_name(), r"^AutoDubVideoLocal-[0-9a-f]{16}$")

    def test_second_instance_notifies_the_primary_instance(self):
        server_name = f"AutoDubVideoLocal-test-{uuid.uuid4().hex}"
    ...
    def test_lock_and_activation_work_across_processes(self):
        server_name = f"AutoDubVideoLocal-process-test-{uuid.uuid4().hex}"
        ...
        primary_code = "\n".join(
            (
                ...
                "from autodub.desktop.single_instance import SingleInstanceCoordinator",
