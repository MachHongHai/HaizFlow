...
OMNIVOICE_TTS_VOICES = [
    ("omnivoice:female", "Natural female", "natural"),
    ("omnivoice:male", "Natural male", "natural"),
    ("omnivoice:female_low", "Warm female", "natural"),
    ("omnivoice:deep", "Deep male", "natural"),
    ("omnivoice:bright", "Bright female", "natural"),
    ("omnivoice:male_high", "Bright male", "natural"),
    ("omnivoice:female_mature", "Mature female", "natural"),
    ("omnivoice:male_mature", "Mature male", "natural"),
    ("omnivoice:female_soprano", "Clear high female", "natural"),
    ("omnivoice:male_tenor", "Clear high male", "natural"),
    ("omnivoice:female_narrator", "Female narrator", "narration"),
    ("omnivoice:male_narrator", "Male narrator", "narration"),
    ("omnivoice:female_elder_high", "Lively elder female", "narration"),
    ("omnivoice:male_elder_high", "Lively elder male", "narration"),
    ("omnivoice:elder", "Elder narrator", "narration"),
    ("omnivoice:storyteller", "Deep storyteller", "narration"),
    ("omnivoice:whisper", "Soft whisper", "style"),
    ("omnivoice:whisper_low", "Deep whisper", "style"),
    ("omnivoice:whisper_high", "Bright whisper", "style"),
    ("omnivoice:whisper_elder", "Elder whisper", "style"),
    ("omnivoice:child", "Young voice", "style"),
